     ...
     var requesttime = document.getElementById('requesttime').value;
      ...
      if( document.myForm1.requestname.value == ""  ) {
       ...
       /* else if( document.myForm1.requestemail.value == ""  ) {
            ...
            if (document.myForm1.requestemail.value == "" || document.myForm1.requestemail.value == undefined){
               var requestemail= "NA";
            }
   
            if (document.myForm1.requestcomments.value == "" || document.myForm1.requestcomments.value == undefined){
               var requestcomments= "NA";
            }
             ...
             var data = JSON.stringify({token:"829ca790bf0d5b0ff3c82ed7c3d2c332e305eb6c",
                               ...
                               globalmedia:"https://williamstown-2022.web.app/images/opengraph.jpg",
                               data: [
                                 {
                                 ...
                                 template_message: [
                                   ...
                                   requesttime,
                                   requestcomments,
								   "*This is system generated message,for any queries please call (9381143154)*"
                                 ],
                              language: "en"
                            },
                            {
     ...
     var bookingtime = document.getElementById('bookingtime').value;
      ...
      if( document.myForm2.bookingname.value == ""  ) {
       ...
       /*  else if( document.myForm2.bookingemail.value == "" ) {
         ...
         else {if (document.myForm2.bookingemail.value == "" || document.myForm2.bookingemail.value == undefined){
            var bookingemail= "NA";
         }
